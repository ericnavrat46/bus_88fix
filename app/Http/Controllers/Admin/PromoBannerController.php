...
class PromoBannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'promo_code'      => 'required|string|alpha_num|max:20|unique:promo_banners,promo_code',
    ...
    public function update(Request $request, PromoBanner $promoBanner)
    {
        $validated = $request->validate([
            ...
            'title'           => 'required|string|max:100',
            'description'     => 'nullable|string|max:200',
            'promo_code'      => 'required|string|alpha_num|max:20|unique:promo_banners,promo_code,' . $promoBanner->id,
            'start_date'      => 'required|date',
            'end_date'        => 'required|date|after_or_equal:start_date',
            'link'            => 'nullable|url',
            'is_active'       => 'nullable|boolean',
