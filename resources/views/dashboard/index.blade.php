    ...
    <div id="editProfileContainer" class="mb-8">
        ...
        <div id="otpSection" class="form-section p-8 bg-white rounded-3xl shadow-xl border border-slate-100">
             ...
             <div id="step1SendOtp">
                ...
                <button type="button" id="sendOtpBtn" class="w-full md:w-auto px-8 py-3 bg-red-600 text-white font-bold rounded-xl hover:bg-red-700 shadow-lg shadow-red-600/20 transition-all">
                    📧 Kirim OTP
                </button>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    @endphp
                    <a href="{{ $waLink }}" target="_blank" class="flex items-center justify-center gap-3 w-full py-4 bg-red-600 text-white font-extrabold rounded-2xl hover:bg-red-700 transition-all shadow-lg shadow-red-600/20">
