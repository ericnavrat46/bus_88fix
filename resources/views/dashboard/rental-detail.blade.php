    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="card p-8">
            ...
            <div class="mt-8 pt-8 border-t border-gray-warm-100 flex flex-col sm:flex-row gap-4">
                <a href="https://wa.me/6285784898590?text=Halo CS Bus 88, saya ingin bertanya tentang sewa bus {{ $rental->rental_code }} saya." target="_blank" class="btn-secondary flex-1 py-3 font-bold flex items-center justify-center gap-2">
