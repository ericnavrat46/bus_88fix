...
@section('content')
    ...
    <section class="relative overflow-hidden hero-section" style="min-height: 90vh;">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <img src="{{ asset('images/bg.png') }}" alt="Bus IND'S 88 Trans"
                class="w-full h-full object-cover object-center hero-img">
            {{-- Overlay gelap supaya teks tetap terbaca --}}
            <div class="absolute inset-0"
                style="background: linear-gradient(105deg, rgba(10,0,0,0.82) 0%, rgba(140,0,0,0.65) 50%, rgba(10,0,0,0.45) 100%);">
            </div>
        </div>
        ...
        <div class="absolute inset-0 pointer-events-none">
            ...
            <div
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-white/3 rounded-full blur-3xl">
            </div>
            {{-- Pattern overlay --}}
            <div class="absolute inset-0"
                style="background-image: radial-gradient(circle at 25% 25%, rgba(255,255,255,0.05) 1px, transparent 1px); background-size: 50px 50px;">
            </div>

            {{-- 3D Floating Shapes --}}
            <div class="hidden lg:block absolute top-[15%] right-[8%] shape-3d-ring opacity-40"></div>
            <div class="hidden lg:block absolute bottom-[20%] left-[5%] shape-3d-cube opacity-50"
                style="animation-delay: 2s;"></div>
            <div class="hidden lg:block absolute top-[30%] left-[15%] w-3 h-3 bg-white/20 rounded-full animate-orbit"
                style="animation-duration: 18s;"></div>
            <div class="hidden lg:block absolute bottom-[35%] right-[20%] w-2 h-2 bg-merah-400/30 rounded-full animate-orbit"
                style="animation-duration: 14s; animation-delay: 3s;"></div>
            <div class="hidden lg:block absolute top-[60%] right-[12%] w-6 h-6 border border-white/15 rounded-lg animate-float-3d"
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white animate-slide-up">
                    ...
                    <p class="text-lg text-white/80 leading-relaxed mb-8 max-w-lg">
                        Layanan tiket bus antar kota dan sewa bus charter terpercaya. Harga transparan, pembayaran mudah via
                        Midtrans.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        ...
                        <a href="{{ route('rental.index') }}"
                            class="inline-flex items-center justify-center px-6 py-3 bg-white/10 text-white font-semibold rounded-xl border-2 border-white/20 backdrop-blur-sm btn-hero-ghost">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <form action="{{ route('schedules.search') }}" method="GET" class="space-y-4">
                            ...
                            <div class="grid gap-4" :class="tripType === 'round_trip' ? 'grid-cols-2' : 'grid-cols-1'">
                                <div>
                                    ...
                                    <input type="date" name="date" id="departure_date" class="input-field"
                                ...
                                <div x-show="tripType === 'round_trip'"
                                    ...
                                    <input type="date" name="return_date" x-ref="returnDate" class="input-field"
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14 reveal-3d">
                <h2 class="text-3xl lg:text-4xl font-black text-dark mb-4">Mengapa <span class="text-gradient-merah">Bus
                        88</span>?</h2>
                <p class="text-gray-warm-500 text-lg max-w-2xl mx-auto">Kami berkomitmen memberikan layanan transportasi
                    terbaik untuk perjalanan Anda</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8 perspective-container">
                {{-- Feature 1 — 3D Tilt --}}
                <div class="tilt-card reveal-3d" data-tilt>
                    <div
                        class="tilt-card-inner card-premium p-8 text-center group feature-card tilt-shadow relative overflow-hidden">
                        <div class="tilt-shine"></div>
                        <div
                            class="w-16 h-16 bg-merah-100 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-merah-600 transition-colors duration-300 feature-icon">
                            <svg class="w-8 h-8 text-merah-600 group-hover:text-white transition-colors duration-300"
                        ...
                        <h3
                            class="text-xl font-bold text-dark mb-3 group-hover:text-merah-700 transition-colors duration-300">
                            Aman & Terpercaya</h3>
                        <p class="text-gray-warm-500 leading-relaxed">Armada terawat dengan pengemudi profesional
                            berpengalaman untuk keselamatan Anda</p>
                    </div>
                </div>
                {{-- Feature 2 — 3D Tilt --}}
                <div class="tilt-card reveal-3d" data-tilt style="transition-delay: 0.15s;">
                    <div
                        ...
                        <h3
                            class="text-xl font-bold text-dark mb-3 group-hover:text-merah-700 transition-colors duration-300">
                            Harga Transparan</h3>
                        <p class="text-gray-warm-500 leading-relaxed">Harga jelas tanpa biaya tersembunyi. Pembayaran mudah
                            via Midtrans</p>
                    </div>
                </div>
                {{-- Feature 3 — 3D Tilt --}}
                <div class="tilt-card reveal-3d" data-tilt style="transition-delay: 0.3s;">
                    <div
                        ...
                        <h3
                            class="text-xl font-bold text-dark mb-3 group-hover:text-merah-700 transition-colors duration-300">
                            Booking Cepat</h3>
                        <p class="text-gray-warm-500 leading-relaxed">Pesan tiket dalam hitungan menit. Pilih kursi favorit
                            dan bayar langsung</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-5xl font-black text-dark mb-4">Temukan Rute <span
                        class="text-gradient-merah">Terbaik</span></h2>
                <p class="text-gray-warm-500 text-lg">Perjalanan nyaman, aman, dan terjangkau ke berbagai destinasi pilihan
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                <div
                    class="group flex items-center gap-4 p-4 rounded-2xl bg-gray-warm-50 border border-gray-warm-100 hover:bg-white hover:border-merah-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                    <div
                        class="w-10 h-10 bg-merah-50 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-merah-600 transition-colors duration-300">
                        <svg class="w-5 h-5 text-merah-600 group-hover:text-white transition-colors duration-300"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    ...
                    <div>
                        <h4
                            class="text-xs font-black text-dark uppercase tracking-wider group-hover:text-merah-700 transition-colors duration-300">
                            Harga Terbaik</h4>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                @forelse($popularRoutes->take(4) as $pr)
                    <div
                        class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 group flex flex-col h-full border border-gray-warm-100">
                        {{-- Image Header --}}
                        <div class="relative h-48 md:h-52 overflow-hidden">
                            ...
                            @if($pr->badge_text)
                                <div class="absolute top-4 right-4">
                                    <span
                                        class="bg-merah-600 text-white text-[8px] font-black px-2.5 py-1 rounded-lg shadow-lg uppercase tracking-wider">
                                        {{ $pr->badge_text }}
                                    </span>
                                </div>
                            @endif
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            ...
                            <div class="flex items-center gap-4 mb-6">
                                <div class="flex items-center gap-1.5 text-gray-warm-400">
                                    ...
                                    <span
                                        class="text-[10px] font-bold">{{ $pr->duration_display ?? $pr->route->formatted_duration }}</span>
                                </div>
                                <div class="flex items-center gap-1.5 text-gray-warm-400">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @empty
                    ...
                    @foreach($routes->take(4) as $route)
                        <div class="bg-white rounded-3xl p-5 border border-gray-warm-100 flex flex-col">
                            ...
                            <a href="{{ route('schedules.search') }}?origin={{ $route->origin }}&destination={{ $route->destination }}&date={{ date('Y-m-d') }}"
                                class="mt-auto py-2 text-center bg-merah-600 text-white rounded-xl text-xs font-bold">Cari
                                Jadwal</a>
                        </div>
                    @endforeach
                @endforelse
            ...
            {{-- Bottom Banner --}}
            <div
                class="bg-merah-50 rounded-[2rem] p-4 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4 border border-merah-100">
                <div class="flex items-center gap-4">
                    <div
                        class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-merah-600 shadow-sm shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-gray-warm-500">Pilih jadwal keberangkatan yang sesuai dengan rencana
                            perjalanan Anda.</p>
                    </div>
                </div>
                <a href="#search"
                    class="px-6 py-3 bg-white border border-merah-100 text-merah-600 text-xs font-black rounded-xl hover:bg-merah-600 hover:text-white transition-all flex items-center gap-2"
                    onclick="document.getElementById('search').scrollIntoView({behavior: 'smooth'}); return false;">
                    Lihat Semua Jadwal
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M14 5l7 7m0 0l-7 7m7-7H3" />
    ...
    @if($promoBanners->isNotEmpty())
        <section id="promo-section" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-8">
                    <div>
                        <h2 class="text-2xl lg:text-3xl font-black text-dark">Promo <span
                                class="text-gradient-merah">Terbatas</span></h2>
                            ...
                            <div class="swiper-slide relative group cursor-pointer aspect-promo"
                                ...
                                <div class="absolute inset-0 flex items-center px-8 md:px-16">
                                        ...
                                        @if($banner->description)
                                            <p class="text-sm md:text-lg text-white/80 mb-6 line-clamp-2 transform translate-y-4 opacity-0 
                                                   transition-all duration-700 delay-200 group-[.swiper-slide-active]:translate-y-0 group-[.swiper-slide-active]:opacity-100">
                                                {{ $banner->description }}
                                        ...
                                        <div class="flex flex-wrap items-center gap-4 transform translate-y-4 opacity-0 transition-all duration-700 delay-300 group-[.swiper-slide-active]:translate-y-0 group-[.swiper-slide-active]:opacity-100">
                                            {{-- Promo Code Box --}}
                                            <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl px-4 py-3 flex 
    ...
    @if($reviews->isNotEmpty())
        <section class="
                       py-24 bg-white overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateCountdowns() {
                    ...
                    timers.forEach(timer => {
                        ...
                        timer.innerHTML = `${days}h ${hours}j ${minutes}m`;
                    });
                }
